...
public sealed class GetCustomerNotesQueryValidator : AbstractValidator<GetCustomerNotesQuery>
{
    public GetCustomerNotesQueryValidator(ILocalizationService localization)
    {
