...
public sealed class UpdateAssignmentRuleCommandValidator : AbstractValidator<UpdateAssignmentRuleCommand>
{
    public UpdateAssignmentRuleCommandValidator(ILocalizationService localization)
    {
        RuleFor(x => x.Id)
