...
public sealed class StartAiChatCommandValidator : AbstractValidator<StartAiChatCommand>
{
    public StartAiChatCommandValidator(ILocalizationService localization)
    {
        RuleFor(x => x.Name)
